...
- [`streamsCreateStream`](docs/sdks/public/README.md#createstream) - Create a new stream
- [`streamsCreateStream`](docs/sdks/streams/README.md#createstream) - Create a new stream
- [`streamsDeleteStream`](docs/sdks/public/README.md#deletestream) - Delete a stream
- [`streamsDeleteStream`](docs/sdks/streams/README.md#deletestream) - Delete a stream
- [`streamsGetAllStreams`](docs/sdks/public/README.md#getallstreams) - Get all streams for user
- [`streamsGetAllStreams`](docs/sdks/streams/README.md#getallstreams) - Get all streams for user
- [`streamsGetStreamById`](docs/sdks/public/README.md#getstreambyid) - Get stream by ID
...
async function run() {
  const result = await daydreamTest.streams.createStream(undefined, {
    retries: {
      strategy: "backoff",
      backoff: {
        initialInterval: 1,
...
You can also enable a default debug logger by setting an environment variable `DAYDREAMTEST_DEBUG` to true.
<!-- End Debugging [debug] -->
