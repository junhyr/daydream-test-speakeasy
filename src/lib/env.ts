...
export interface Env {
  DAYDREAMTEST_BEARER?: string | undefined;

  DAYDREAMTEST_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  DAYDREAMTEST_BEARER: z.string().optional(),

  DAYDREAMTEST_DEBUG: z.coerce.boolean().optional(),
});
